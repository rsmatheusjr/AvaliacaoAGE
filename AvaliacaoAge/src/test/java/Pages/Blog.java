...
public class Blog {
	...
	public void acessarSite() {
		...
		if(validarTelaBusca().contentEquals("BUSCA BLOG")) {
			...
			Utils.log(Status.FAIL, driver.findElement(By.tagName("h1")), "Erro ao acessar site de busca. Esperado por 'BUSCA BLOG'.");
		}
	}
