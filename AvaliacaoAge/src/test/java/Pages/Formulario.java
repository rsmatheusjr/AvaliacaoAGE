...
public class Formulario {
	...
	public String validarEmpresa() {
		...
		if(campoEmpresa.getText().trim().contentEquals(Formulario.getEmpresa().trim())){
			Utils.log(Status.PASS, campoEmpresa, "Validar nome da empresa");
		}else {
			Utils.log(Status.FAIL, campoEmpresa, "Erro ao validar nome da empresa");
		}
	...
	public String validarMaximo() {
		...
		if(campoMaximo.getText().trim().contentEquals(Formulario.getMaximo().trim())) {
			Utils.log(Status.PASS, campoMaximo, "Validar recolhimento maximo");			
		}else {
			Utils.log(Status.FAIL, campoMaximo, "Erro ao validar recolhimento maximo");	
		}
	...
	public String validarMinimo() {
		...
		if(campoMinimo.getText().trim().contentEquals(Formulario.getMinimo().trim())) {
	...
	public String validarEconomia() {
		...
		if(campoEconomia.getText().trim().contentEquals(Formulario.getEconomia().trim())) {
			Utils.log(Status.PASS, campoEconomia, "Validar passivel de economia");
			
		}else {
			Utils.log(Status.FAIL, campoEconomia, "Erro ao validar passivel de economia");			
		}
